  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="mb-6 text-4xl font-bold tracking-tight md:text-5xl animate-slide-up">
              <span className="heading-gradient animate-glow">Events & Workshops</span>
            </h1>
            <p
            ...
            <TabsContent value="upcoming" className="animate-fade-in">
              {upcomingEvents.length > 0 ? (
                ...
                <div className="rounded-lg border border-dashed p-10 text-center animate-fade-in">
                  ...
                  <p className="mb-6 text-muted-foreground">We're currently planning new events. Check back soon!</p>
                </div>
              )}
            </TabsContent>
            <TabsContent value="past" className="animate-fade-in">
              {pastEvents.length > 0 ? (
                ...
                <div className="rounded-lg border border-dashed p-10 text-center animate-fade-in">
                  ...
                  <p className="text-muted-foreground">Our event history will appear here once events are completed.</p>
                </div>
              )}
            </TabsContent>
          </Tabs>
      ...
      <section className="section-padding bg-muted">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-6 text-3xl font-bold md:text-4xl animate-slide-up">Want to Collaborate?</h2>
