        ...
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="mb-6 text-4xl font-bold tracking-tight md:text-5xl animate-slide-up">
              <span className="heading-gradient">Events & Workshops</span>
            </h1>
            <p
      ...
      <section className="section-padding bg-muted z-10">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              If you're interested in hosting an event with us or have ideas for workshops, we'd
  ...
  return (
    ...
    >
      ...
      <CardContent className="p-6">
        ...
        <Button variant={isPast ? 'outline' : 'default'} className="hover-lift pointer-events-none">
...
function EventModal({ event, onClose }: EventModalProps) {
  ...
  return (
    ...
    >
      <div
        className="relative mt-16 max-w-4xl w-full max-h-[90vh] overflow-y-auto bg-card rounded-lg shadow-2xl animate-slide-up"
      ...
      >
        ...
        <div className="p-8">
          <h2 className="text-3xl font-bold mb-4 heading-gradient">{event.title}</h2>
          ...
          <div className="mb-6">
            <h3 className="text-lg font-semibold mb-2">
              {isPast ? 'Event Summary' : 'Description'}
            </h3>
            {event.details ? (
