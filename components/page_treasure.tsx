...
import Treasurehunt from '../app/events/treasurehunt';
...
const AnimatedPlayButton = () => {
  ...
  useEffect(() => {
    const targetDate = new Date("March 24, 2025 21:07:00").getTime()
  ...
  const handleNavigateToTreasureHunt = () => {
    router.push('/events/treasurehunt');
  };
  return (
